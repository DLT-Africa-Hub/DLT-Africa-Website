...
export default function FooterCtaGraphic() {
  return (
    <div
      className="hidden md:pointer-events-none md:absolute md:bottom-[-6px] md:right-[-2px] md:top-[11%] md:z-0 md:mt-0 md:block md:h-auto md:w-[min(44%,400px)] md:min-w-[260px] md:max-w-none lg:right-[-6px] lg:w-[min(38%,440px)]"
      aria-hidden
    >
